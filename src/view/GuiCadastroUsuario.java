...
public class GuiCadastroUsuario extends JFrame {
	...
	public GuiCadastroUsuario(BD bd) {
	    this.bd = bd;
	    this.usuario = null;
	...
	public GuiCadastroUsuario(BD bd, Usuario usuario) {
	    this.bd = bd;
	...
	private void inicializarComponentes() {
		...
		cmbFuncao.setToolTipText("Função");
	...
	private void cancelar() {
	    dispose();
	    GuiListarUsuario tela = new GuiListarUsuario(bd);
	...
	private void excluir() {
	    ...
	    dao = new UsuarioDAO(bd);

	    String mensagem = dao.atualizar(
	        usuario,
	        TipoOperacaoBD.EXCLUSAO
	    );

	    JOptionPane.showMessageDialog(this, mensagem);

	    if (!mensagem.startsWith("Falha")) {
	        cancelar();
	    }
	}
	...
	private void salvar() {
	    ...
	    if (modoEdicao) {
	        mensagem = dao.atualizar(usuarioTela, TipoOperacaoBD.ALTERACAO);
	    } else {
	        mensagem = dao.atualizar(usuarioTela, TipoOperacaoBD.INCLUSAO);
	    }
